...
export const socket = io("https://riveanimationsbackend-production.up.railway.app");
export const ioSocket = socket.connect("https://riveanimationsbackend-production.up.railway.app");
